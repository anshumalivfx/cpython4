...
#define INIT_IDENTIFIERS_ADD(name) if ((state->name = PyUnicode_InternFromString(#name)) == NULL) return 0

static int init_identifiers(struct ast_state *state)
{
    INIT_IDENTIFIERS_ADD(__dict__);
    INIT_IDENTIFIERS_ADD(__doc__);
    INIT_IDENTIFIERS_ADD(__match_args__);
    INIT_IDENTIFIERS_ADD(__module__);
    INIT_IDENTIFIERS_ADD(_attributes);
    INIT_IDENTIFIERS_ADD(_fields);
    INIT_IDENTIFIERS_ADD(annotation);
    INIT_IDENTIFIERS_ADD(arg);
    INIT_IDENTIFIERS_ADD(args);
    INIT_IDENTIFIERS_ADD(argtypes);
    INIT_IDENTIFIERS_ADD(asname);
    INIT_IDENTIFIERS_ADD(ast);
    INIT_IDENTIFIERS_ADD(attr);
    INIT_IDENTIFIERS_ADD(bases);
    INIT_IDENTIFIERS_ADD(body);
    INIT_IDENTIFIERS_ADD(cases);
    INIT_IDENTIFIERS_ADD(cause);
    INIT_IDENTIFIERS_ADD(cls);
    INIT_IDENTIFIERS_ADD(col_offset);
    INIT_IDENTIFIERS_ADD(comparators);
    INIT_IDENTIFIERS_ADD(context_expr);
    INIT_IDENTIFIERS_ADD(conversion);
    INIT_IDENTIFIERS_ADD(ctx);
    INIT_IDENTIFIERS_ADD(decorator_list);
    INIT_IDENTIFIERS_ADD(defaults);
    INIT_IDENTIFIERS_ADD(elt);
    INIT_IDENTIFIERS_ADD(elts);
    INIT_IDENTIFIERS_ADD(end_col_offset);
    INIT_IDENTIFIERS_ADD(end_lineno);
    INIT_IDENTIFIERS_ADD(exc);
    INIT_IDENTIFIERS_ADD(finalbody);
    INIT_IDENTIFIERS_ADD(format_spec);
    INIT_IDENTIFIERS_ADD(func);
    INIT_IDENTIFIERS_ADD(generators);
    INIT_IDENTIFIERS_ADD(guard);
    INIT_IDENTIFIERS_ADD(handlers);
    INIT_IDENTIFIERS_ADD(id);
    INIT_IDENTIFIERS_ADD(ifs);
    INIT_IDENTIFIERS_ADD(is_async);
    INIT_IDENTIFIERS_ADD(items);
    INIT_IDENTIFIERS_ADD(iter);
    INIT_IDENTIFIERS_ADD(key);
    INIT_IDENTIFIERS_ADD(keys);
    INIT_IDENTIFIERS_ADD(keywords);
    INIT_IDENTIFIERS_ADD(kind);
    INIT_IDENTIFIERS_ADD(kw_defaults);
    INIT_IDENTIFIERS_ADD(kwarg);
    INIT_IDENTIFIERS_ADD(kwd_attrs);
    INIT_IDENTIFIERS_ADD(kwd_patterns);
    INIT_IDENTIFIERS_ADD(kwonlyargs);
    INIT_IDENTIFIERS_ADD(left);
    INIT_IDENTIFIERS_ADD(level);
    INIT_IDENTIFIERS_ADD(lineno);
    INIT_IDENTIFIERS_ADD(lower);
    INIT_IDENTIFIERS_ADD(module);
    INIT_IDENTIFIERS_ADD(msg);
    INIT_IDENTIFIERS_ADD(name);
    INIT_IDENTIFIERS_ADD(names);
    INIT_IDENTIFIERS_ADD(op);
    INIT_IDENTIFIERS_ADD(operand);
    INIT_IDENTIFIERS_ADD(ops);
    INIT_IDENTIFIERS_ADD(optional_vars);
    INIT_IDENTIFIERS_ADD(orelse);
    INIT_IDENTIFIERS_ADD(pattern);
    INIT_IDENTIFIERS_ADD(patterns);
    INIT_IDENTIFIERS_ADD(posonlyargs);
    INIT_IDENTIFIERS_ADD(rest);
    INIT_IDENTIFIERS_ADD(returns);
    INIT_IDENTIFIERS_ADD(right);
    INIT_IDENTIFIERS_ADD(simple);
    INIT_IDENTIFIERS_ADD(slice);
    INIT_IDENTIFIERS_ADD(step);
    INIT_IDENTIFIERS_ADD(subject);
    INIT_IDENTIFIERS_ADD(tag);
    INIT_IDENTIFIERS_ADD(target);
    INIT_IDENTIFIERS_ADD(targets);
    INIT_IDENTIFIERS_ADD(test);
    INIT_IDENTIFIERS_ADD(type);
    INIT_IDENTIFIERS_ADD(type_comment);
    INIT_IDENTIFIERS_ADD(type_ignores);
    INIT_IDENTIFIERS_ADD(upper);
    INIT_IDENTIFIERS_ADD(value);
    INIT_IDENTIFIERS_ADD(values);
    INIT_IDENTIFIERS_ADD(vararg);
    return 1;
};

#undef INIT_IDENTIFIERS_RENAME_THIS
